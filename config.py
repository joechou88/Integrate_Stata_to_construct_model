...
STATA_DERIVE_COLUMNS_OUTPUT = os.path.join(STATA_DIR, "Financial_npv_lease20152024_derive_columns.dta")
STATA_Model1_OUTPUT = os.path.join(STATA_DIR, "Financial_npv_lease20152024_model_1.dta")
STATA_Model2_OUTPUT = os.path.join(STATA_DIR, "Financial_npv_lease20152024_model_2.dta")
STATA_Model3_OUTPUT = os.path.join(STATA_DIR, "Financial_npv_lease20152024_model_3.dta")
